...
class Radio:
    ...
    def __get_radio_fav_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/local_radio_fav')
    # 获取听歌识曲控件 未识别到歌曲
    def __get_radio_ide_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/played_program_identify')
    # 获取正在播放的项目名称
    def __get_radio_name_playing_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/played_program')
    # 获取正在播放的收音机节目列表
    def __get_radio_list_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/played_program_list')
    # 获取播放控件
    def __get_radio_play_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/play')
    # 获取收音机播放时间控件
    ...
    def __get_radio_selector_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':drawable/selector_fm')
    # 获取预览radio的控件
    def __get_radio_preview_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':drawable/selector_play_all_radio')
    # 获取回到主界面控件
    def __get_radio_home_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':drawable/selector_home')
    # 获取蜻蜓FM的控件
    def __get_radio_qt_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':drawable/selector_net')
    # 获取收音机搜索控件
    def __get_radio_search_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':drawable/menu_selector_search')
    #获取FM选择tab控件
    def __get_radio_selector_fm_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/list_band_fm')
    # 获取FM列表的listview
    def __get_radio_selector_fm_listview_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/gridview')
    # 获取FM列表中的节目栏容器
    def __get_radio_selector_fm_listview_container_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/container')
    # 获取FM/AM列表中的收藏控件
    def __get_radio_selector_fav_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/crown')
    # 获取FM/AM窗口控件
    ...
    def __get_radio_qt_drawer_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/drawer_net')
    # 获取精选电台控件
    def __get_radio_qt_category_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/category_selected')
    # 获取电台栏目控件
    def __get_radio_qt_category_title_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/display_name')
    # 获取电台栏目中节目列表窗口
    def __get_radio_qt_category_list_drawer_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/drawer_album_program')
    # 获取电台栏目节目列表标题控件
    def __get_radio_qt_category_list_title_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/album_title_name')
    # 获取电台栏目节目列表的节目名称
    def __get_radio_qt_category_list_name_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/album_program_name')
    # 获取蜻蜓FM的收藏控件
    def __get_radio_qt_fav_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/favorite')
    # 获取蜻蜓FM的栏目控件
    def __get_radio_qt_title_playing_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/album_tv')
    # 获取蜻蜓FM窗口中的我的收藏
    def __get_radio_qt_collected_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/category_collected')
    # 获取收藏的标题控件
    def __get_radio_qt_collected_title_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/favorite_album_name')
    # 获取最近收听的控件
    def __get_radio_qt_latest_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/category_latest')
    # 获取蜻蜓FM最近收听节目控件
    def __get_radio_qt_latest_name_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/latest_program_name')
    # 获取收音机列表窗口控件
    def __get_radio_list_drawer_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/drawer_program')
    # 获取收音机列表的listview控件
    def __get_radio_list_listview_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/program_listview')
    # 获取收音机列表中的节目控件
    def __get_radio_list_name_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/program_name')
    # 获取搜索框控件
    def __get_radio_search_keyword_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/search_keyword')
    # 获取搜索清空控件
    def __get_radio_search_clear_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/icon_search_clear')
    # 获取取消搜索控件
    def __get_radio_search_cancel_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/lab_cancel')
    # 获取搜索列表中节目title
    ...
    def __get_radio_search_list_title_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/txt_detail')
    #获取收音机的微调控件
    def get_radio_weitiao_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/play_time')

    # 获取听歌识曲中的歌曲名称控件
    def __get_radio_ide_audio_name_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/gracenote_track_tv')
    ...
    def click_radio_prev_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('上一首控件不存在')
    ...
    def click_radio_next_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('下一首控件不存在')
    # 点击播放或者暂停收音机
    def click_radio_pause_or_play_ele(self):
        ...
        if next_ele.wait.exists() and prev_ele.wait.exists():
            ...
            uit.raise_Exception_info('上一首或下一首控件不存在')
    ...
    def get_radio_no_playing_txt(self):
        ...
        if len(ele) > 0:
            ...
            uit.raise_Exception_info('收音机台为空')
    ...
    def click_radio_fav_or_cancel_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('收藏控件不存在')
    # 点击听歌识曲控件
    def click_radio_ide_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('听歌识曲控件不存在')
    ...
    def get_radio_name_playing_txt(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('正在播放的收音机名称控件不存在')
    # 点击收音机列表控件
    def click_radio_list_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('收音机列表控件不存在')
    ...
    def click_radio_play_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('收音机播放控件不存在')
    # 校验收音机是否播放
    # 播放：true 恢复播放控件不可见
    # 暂停：false 恢复播放控件可见
    ...
    def click_radio_selector_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('FM/AM选择控件不存在')
    #点击预览radio控件
    def click_radio_preview_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('收音机预览控件不存在')
    ...
    def click_radio_qt_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('蜻蜓FM控件不存在')
    ...
    def click_radio_search_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('收音机的搜索控件不存在')
    #点击收音机的fm tab页
    def click_radio_selector_fm_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('FM选择tab控件不存在')
    ...
    def refresh_radio_selector_listview(self):
        ...
        if ele.wait.exists():
            ...
            ele_prev.wait.exists(timeout=ht.LONG_TIME_OUT)
        else:
            uit.raise_Exception_info('FM选择界面的listview不存在')
    # 根据fmno播放电台
    ...
    def click_radio_selector_fm_random_ele(self):
        ...
        if size > 0:
            ...
            uit.raise_Exception_info('FM列表内容为空')
    # 隐藏FM/AM选择窗口
    ...
    def get_radio_selector_fm_is_faved_by_no(self, fm_no):
        ...
        if ele.wait.exists():
            ...
            if len(ele_containers) > 0:
                ...
                uit.raise_Exception_info('FM选择界面list为空')
        else:
            uit.raise_Exception_info('FM选择界面的listview不存在')
    ...
    def hide_radio_qt_drawer_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('蜻蜓FM窗口不存在')
    # 点击精选电台
    def click_radio_qt_category_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('精选电台控件不存在')
    # 随机点击栏目
    # 返回title 为了后面校验
    def click_radio_qt_category_title_ele(self):
        ...
        if size > 0:
            ...
            uit.raise_Exception_info('栏目没有加载出来，可能是网络太慢')
    # 隐藏电台栏目节目列表窗口
    def hide_radio_qt_category_list_drawer_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('电台栏目节目窗口不存在')
    ...
    def get_radio_qt_category_list_title_txt(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('蜻蜓FM电台节目列表标题控件不存在')
    # 随机选择节目收听
    def click_radio_qt_category_list_name_random_ele(self):
        ...
        if size > 0:
            ...
            uit.raise_Exception_info('节目列表为空，可能是网络原因')
    ...
    def click_radio_qt_fav_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('蜻蜓FM的收藏控件不存在')
    # 获取蜻蜓FM正在播放的栏目名称
    def get_radio_qt_title_playing_txt(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('正在播放的蜻蜓FM栏目名称控件不存在')
    # 点击进入蜻蜓FM的我的收藏tab页
    def click_radio_qt_collected_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('蜻蜓FM我的收藏控件不存在')
    # 查看指定蜻蜓FM是否被收藏
    # true: 返回被收藏
    # false: 返回没有被收藏
    ...
    def click_radio_qt_latest_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('蜻蜓FM最近收听控件不存在')
    # 查看指定蜻蜓FM节目是否在收听历史中
    ...
    def hide_radio_list_drawer_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('收音机列表窗口不存在')
    ...
    def click_radio_list_his_name_random_ele(self):
        ...
        if ele_listview.exists:
            ...
            uit.raise_Exception_info('网络回听listview控件不存在')
        ...
        if len(ele_name) > 0:
            ...
            if ele_name[idx].sibling(text = '网络回听').exists:
                ...
                uit.raise_Exception_info('没有找到网络回听节目')
        else:
            uit.raise_Exception_info('节目列表为空')
    #点击清空搜索框控件
    def click_radio_search_clear_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('清空搜索框控件不存在')
    ...
    #     输入内容
        ...
        if ele.wait.exists():
            ele.set_text(ht.unicode_input(input_text))
        else:
    ...
    def click_radio_search_cancel_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('取消控件不存在')
    ...
    def click_radio_search_list_title_random_ele(self):
        ...
        if size_name > 0:
            ...
            # 保存在上下文变量中
            ht.set_context_map(title_txt, name_txt)
            ele_name[idx].click.wait()
            # 返回标题名称
            return title_txt

        else:
            uit.raise_Exception_info('收音机搜索结果为空')
    # 播放收藏的电台
    ...
    #   获取listview
        ...
        if ele_listview.exists:
            if ele_listview.scroll.vert.to(resourceId =pkg_name + ':id/crown'):
                ...
                uit.raise_Exception_info('没有找到收藏的电台')
        else:
            uit.raise_Exception_info('FM选择界面的listview不存在')
    ...
    def scroll_radio_weitiao_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('微调控件不存在')
    ...
    def click_radio_home_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('返回主界面的HOME控件不存在')
    ...
    def get_radio_ide_status(self):
        ele = d(text='未识别到歌曲')
        return not ele.wait.exists(timeout=ht.LONG_TIME_OUT)
    ...
    def click_radio_ide_audio(self):
        ...
        if ele.wait.exists(timeout=ht.LONG_TIME_OUT):
            ...
            uit.raise_Exception_info('未识别到歌曲')
