...
class SysSetting:
    ...
    def __get_syssetting_bluetooth_list_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/bluetooth_device_list')

    #获取系统设置退出控件
    def __get_syssetting_exit_ele(self):
        return uit.get_ele_by_resourceId(pkg_name + ':id/btn_exit')
    ...
    def click_syssetting_menu_net_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('设置界面的网络菜单不存在')
    # 点击蓝牙菜单展开
    ...
    def back_to_launcher(self):
        ...
        if ele.exists:
            ...
            uit.raise_Exception_info('系统设置界面的退出控件不存在')
