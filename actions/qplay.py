...
class Qplay:
    ...
    def __get_qplay_selector_ele(self):
        return uit.get_ele_by_resourceId('pateo.dls.qplay:drawable/selector_menu_local')
    ...
    def __get_qplay_local_name_ele(self):
        return uit.get_ele_by_resourceId('pateo.dls.qplay:id/drawer_list_category_text')
    ...
    def __get_qplay_home_ele(self):
        return uit.get_ele_by_resourceId('pateo.dls.qplay:drawable/selector_button_home')
    ...
    def click_qplay_selector_ele(self):
        ...
        if ele.wait.exists():
            ...
            uit.raise_Exception_info('本地音乐选择控件不存在')
    ...
    def get_qplay_play_name(self):
        ...
        if ele.exists:
            ...
            uit.raise_Exception_info('当前没有音乐播放')
    ...
    def click_qplay_home_ele(self):
        ...
        if ele.exists:
            ...
            uit.raise_Exception_info('qplay返回主界面控件不存在')
    ...
    def click_qplay_local_name_random(self):
        ...
        if ele.wait.exists() > 0:
            ...
            uit.raise_Exception_info('qplay音乐列表为空')
